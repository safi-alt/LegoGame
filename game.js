(() => {
  ...
  const PRESETS = [
    ...
    },
    {
      name: "Cherry Blossom",
      bricks: [
        { id: "stem_fork", x: 18, y: 15, color: "#8bc34a", rot: 0, flip: false },
        { id: "stem_1x4", x: 19, y: 18, color: "#689f38", rot: 0, flip: false },
        { id: "stem_1x3", x: 19, y: 22, color: "#689f38", rot: 0, flip: false },
        { id: "leaf_sm", x: 20, y: 20, color: "#81c784", rot: 0, flip: false },
        { id: "leaf_sm", x: 17, y: 23, color: "#81c784", rot: 0, flip: true },
        { id: "petal_1x1", x: 17, y: 14, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 18, y: 13, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 18, y: 14, color: "#ffffff", rot: 0, flip: false },
        { id: "center_1x1", x: 18, y: 15, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_1x1", x: 21, y: 14, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 20, y: 13, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_1x1", x: 20, y: 14, color: "#f48fb1", rot: 0, flip: false },
        { id: "center_1x1", x: 20, y: 15, color: "#ffb300", rot: 0, flip: false },
        { id: "petal_1x1", x: 19, y: 12, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_1x1", x: 19, y: 13, color: "#f48fb1", rot: 0, flip: false },
        { id: "pot_sm", x: 18, y: 25, color: "#a1887f", rot: 0, flip: false },
      ],
    },
    {
      name: "Orchid",
      bricks: [
        { id: "stem_1x4", x: 19, y: 19, color: "#2e7d32", rot: 0, flip: false },
        { id: "stem_1x3", x: 19, y: 23, color: "#2e7d32", rot: 0, flip: false },
        { id: "leaf_md", x: 20, y: 23, color: "#388e3c", rot: 0, flip: false },
        { id: "leaf_md", x: 16, y: 25, color: "#43a047", rot: 0, flip: true },
        { id: "center_dome", x: 18, y: 16, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_curve", x: 16, y: 14, color: "#ba68c8", rot: 0, flip: false },
        { id: "petal_curve", x: 21, y: 14, color: "#ba68c8", rot: 0, flip: true },
        { id: "petal_drop", x: 18, y: 11, color: "#7986cb", rot: 0, flip: false },
        { id: "petal_1x2", x: 17, y: 16, color: "#ba68c8", rot: 0, flip: false },
        { id: "petal_1x2", x: 21, y: 16, color: "#ba68c8", rot: 0, flip: false },
        { id: "petal_1x1", x: 18, y: 18, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 20, y: 18, color: "#f48fb1", rot: 0, flip: false },
        { id: "pot_round", x: 17, y: 26, color: "#6d4c41", rot: 0, flip: false },
      ],
    },
    {
      name: "Lily",
      bricks: [
        { id: "stem_1x6", x: 19, y: 19, color: "#43a047", rot: 0, flip: false },
        { id: "leaf_md", x: 20, y: 24, color: "#66bb6a", rot: 0, flip: false },
        { id: "leaf_md", x: 16, y: 22, color: "#66bb6a", rot: 0, flip: true },
        { id: "petal_fan", x: 18, y: 11, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_drop", x: 16, y: 14, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_drop", x: 21, y: 14, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 13, color: "#fff176", rot: 0, flip: false },
        { id: "petal_1x2", x: 19, y: 17, color: "#ffffff", rot: 0, flip: false },
        { id: "center_1x1", x: 19, y: 14, color: "#ff8f00", rot: 0, flip: false },
        { id: "center_1x1", x: 18, y: 15, color: "#ff8f00", rot: 0, flip: false },
        { id: "center_1x1", x: 20, y: 15, color: "#ff8f00", rot: 0, flip: false },
        { id: "pot_md", x: 17, y: 25, color: "#d7ccc8", rot: 0, flip: false },
      ],
    },
    {
      name: "Poppy",
      bricks: [
        { id: "stem_1x4", x: 19, y: 21, color: "#388e3c", rot: 0, flip: false },
        { id: "stem_1x2", x: 19, y: 25, color: "#388e3c", rot: 0, flip: false },
        { id: "leaf_round", x: 20, y: 23, color: "#66bb6a", rot: 0, flip: false },
        { id: "center_round", x: 18, y: 16, color: "#4e342e", rot: 0, flip: false },
        { id: "petal_fan", x: 17, y: 13, color: "#ef5350", rot: 0, flip: false },
        { id: "petal_2x2", x: 16, y: 16, color: "#ff6f61", rot: 0, flip: false },
        { id: "petal_2x2", x: 20, y: 16, color: "#ff6f61", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 15, color: "#ef5350", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 18, color: "#ef5350", rot: 0, flip: false },
        { id: "pot_sm", x: 18, y: 27, color: "#8d6e63", rot: 0, flip: false },
      ],
    },
    {
      name: "Hibiscus",
      bricks: [
        { id: "stem_1x3", x: 19, y: 21, color: "#388e3c", rot: 0, flip: false },
        { id: "stem_1x3", x: 19, y: 24, color: "#388e3c", rot: 0, flip: false },
        { id: "leaf_lg", x: 15, y: 24, color: "#43a047", rot: 0, flip: false },
        { id: "leaf_md", x: 21, y: 23, color: "#66bb6a", rot: 0, flip: false },
        { id: "center_dome", x: 18, y: 17, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_point", x: 19, y: 14, color: "#ff6f61", rot: 0, flip: false },
        { id: "petal_fan", x: 17, y: 13, color: "#ef5350", rot: 0, flip: false },
        { id: "petal_2x2", x: 16, y: 17, color: "#ff8a65", rot: 0, flip: false },
        { id: "petal_2x2", x: 21, y: 17, color: "#ff8a65", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 19, color: "#ff6f61", rot: 0, flip: false },
        { id: "petal_2x1", x: 20, y: 19, color: "#ff6f61", rot: 0, flip: false },
        { id: "pot_md", x: 17, y: 27, color: "#ef9a9a", rot: 0, flip: false },
      ],
    },
    {
      name: "Bouquet",
      bricks: [
        { id: "stem_1x3", x: 16, y: 19, color: "#43a047", rot: 0, flip: false },
        { id: "stem_1x4", x: 19, y: 18, color: "#388e3c", rot: 0, flip: false },
        { id: "stem_1x3", x: 22, y: 19, color: "#43a047", rot: 0, flip: false },
        { id: "center_1x1", x: 16, y: 17, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_1x1", x: 15, y: 17, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_1x1", x: 17, y: 17, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_1x1", x: 16, y: 16, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 16, y: 18, color: "#f48fb1", rot: 0, flip: false },
        { id: "center_2x2", x: 18, y: 14, color: "#795548", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 13, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 16, color: "#ffb300", rot: 0, flip: false },
        { id: "petal_1x2", x: 17, y: 14, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_1x2", x: 20, y: 14, color: "#ffb300", rot: 0, flip: false },
        { id: "center_1x1", x: 22, y: 17, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_1x1", x: 21, y: 17, color: "#ba68c8", rot: 0, flip: false },
        { id: "petal_1x1", x: 23, y: 17, color: "#ba68c8", rot: 0, flip: false },
        { id: "petal_1x1", x: 22, y: 16, color: "#7986cb", rot: 0, flip: false },
        { id: "petal_1x1", x: 22, y: 18, color: "#7986cb", rot: 0, flip: false },
        { id: "leaf_sm", x: 14, y: 20, color: "#81c784", rot: 0, flip: true },
        { id: "leaf_sm", x: 23, y: 20, color: "#aed581", rot: 0, flip: false },
        { id: "leaf_md", x: 15, y: 21, color: "#66bb6a", rot: 0, flip: true },
        { id: "leaf_md", x: 22, y: 21, color: "#66bb6a", rot: 0, flip: false },
        { id: "pot_lg", x: 15, y: 22, color: "#8d6e63", rot: 0, flip: false },
      ],
    },
    {
      name: "Lotus",
      bricks: [
        { id: "x_2x2", x: 15, y: 22, color: "#4fc3f7", rot: 0, flip: false },
        { id: "x_2x2", x: 17, y: 22, color: "#4fc3f7", rot: 0, flip: false },
        { id: "x_2x2", x: 19, y: 22, color: "#4fc3f7", rot: 0, flip: false },
        { id: "x_2x2", x: 21, y: 22, color: "#4fc3f7", rot: 0, flip: false },
        { id: "x_2x2", x: 23, y: 22, color: "#4fc3f7", rot: 0, flip: false },
        { id: "leaf_lg", x: 15, y: 20, color: "#43a047", rot: 0, flip: false },
        { id: "leaf_lg", x: 21, y: 20, color: "#388e3c", rot: 0, flip: true },
        { id: "center_round", x: 19, y: 17, color: "#fdd835", rot: 0, flip: false },
        { id: "petal_2x2", x: 17, y: 16, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_2x2", x: 21, y: 16, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_2x1", x: 19, y: 15, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_2x1", x: 19, y: 19, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_curve", x: 15, y: 15, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_curve", x: 23, y: 15, color: "#e05a9c", rot: 0, flip: true },
        { id: "petal_fan", x: 18, y: 12, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_2x1", x: 18, y: 20, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_2x1", x: 20, y: 20, color: "#ffffff", rot: 0, flip: false },
      ],
    },
    {
      name: "Bonsai",
      bricks: [
        { id: "stem_1x4", x: 19, y: 20, color: "#795548", rot: 0, flip: false },
        { id: "stem_1x3", x: 19, y: 17, color: "#795548", rot: 0, flip: false },
        { id: "leaf_round", x: 17, y: 13, color: "#43a047", rot: 0, flip: false },
        { id: "leaf_round", x: 19, y: 12, color: "#388e3c", rot: 0, flip: false },
        { id: "leaf_round", x: 21, y: 13, color: "#43a047", rot: 0, flip: false },
        { id: "leaf_round", x: 18, y: 15, color: "#66bb6a", rot: 0, flip: false },
        { id: "leaf_round", x: 20, y: 15, color: "#66bb6a", rot: 0, flip: false },
        { id: "leaf_round", x: 16, y: 15, color: "#81c784", rot: 0, flip: false },
        { id: "leaf_round", x: 22, y: 15, color: "#81c784", rot: 0, flip: false },
        { id: "petal_1x1", x: 17, y: 13, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 21, y: 14, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_1x1", x: 19, y: 12, color: "#f48fb1", rot: 0, flip: false },
        { id: "petal_1x1", x: 20, y: 14, color: "#ffffff", rot: 0, flip: false },
        { id: "petal_1x1", x: 22, y: 15, color: "#e05a9c", rot: 0, flip: false },
        { id: "petal_1x1", x: 16, y: 16, color: "#f48fb1", rot: 0, flip: false },
        { id: "pot_rect", x: 17, y: 24, color: "#6d4c41", rot: 0, flip: false },
      ],
    },
  ];
